...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * └───┴───┴───┼───┼───┼───┼───┤           ├───┼───┼───┼───┼───┴───┴───┘
     *             │GUI│SHF│SPC│LWR│           │RSE│ENT│BSP│ALT│
     *             └───┴───┼───┼───┤           ├───┼───┴───┴───┘
     *                     │TAB│ESC│           │DEL│SPC│
     *                     └───┴───┘           └───┴───┘
     */
    [0] = LAYOUT_split(
        KC_9,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_NO,    KC_NO,   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_5,
        KC_8,    KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,    KC_NO,    KC_NO,   KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_4,
        KC_7,    KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    KC_NO,    KC_NO,   KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_3,
        KC_6,    KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_NO,    KC_NO,   KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_2,
                          KC_LGUI, KC_LSFT, KC_SPC,  MO(1),   KC_SPC,   MO(2),   KC_ENT,  KC_BSPC, KC_RALT, KC_TRNS,
                                            KC_TAB,  KC_ESC,           KC_DEL,  KC_SPC
    ),
